@regression @hspheduyetDVKD_full_returnA5_tiepnhanhoso
Feature: Hồ sơ phê duyệt tại Đơn vị kinh doanh - full luồng

  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-01
...
#      | 00013325 | 001-Local Credit Chain              | ABT         | Miễn phí thường niên     | 30000000  |
#      | 00013325 | 001-Local Credit Gold | RGL         | Miễn 50% phí thường niên | 50000000 |
#      | 00015405 | 001-VISA Credit VietJet VIP Partner | RGL         | Miễn 50% phí thường niên | 30000000  |
      | 00013325 | 001-MC Credit Platinum              | RGL         | Thu phí thường niên      | 500000000 |

  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-02
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-03
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-04
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-05
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-06
  Scenario: approve with user a4nv
    Given I access link with "a4nv" and "Abc123!@#"
    When I search with the above request code from "QLPheDuyetYeuCau"
    And I send request with the above file code from A4 user
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-07
...
#      | Phê duyệt tại ĐVKD |
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-08
  Scenario: approve with user a8nv
    Given I access link with "a8nv" and "Abc123!@#"
    When I search with the above request code from "QLPheDuyetYeuCau"
    And I send additional request with the above file code from A8 user
    Then I confirm the above additional request with A8 user

  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-09
  ...
  @hspheduyetDVKD_full_returnA5_tiepnhanhoso-10
