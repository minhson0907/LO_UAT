@regression @hsthepheduyetTTT_assignauto
Feature: Hồ sơ thẻ phê duyệt tại Trung tâm thẻ - Assign auto

  @hsthepheduyetTTT_assignauto-01
  Scenario Outline: register Hồ sơ thẻ phê duyệt tại Trung Tâm Thẻ with cif number
    ...
    And I fill all data in Thông Tin Hồ sơ as below
      | Hồ sơ thẻ phê duyệt tại Trung Tâm Thẻ | 002 ~ CN PHU NHUAN | <record type> | TN01 - TN từ lương |
...
#      | 00003061 | 001-VISA Credit VietJet VIP Partner | RGL         | Miễn 50% phí thường niên | 30000000  |Hồ sơ nhanh|
      | 00003052 | 001-MC Credit Platinum | RGL         | Thu phí thường niên | 500000000 | VIP         |

  @hsthepheduyetTTT_assignauto-02
