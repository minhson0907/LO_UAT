@regression @hspheduyetDVKD_full_returnA6_editA8
Feature: Hồ sơ phê duyệt tại Đơn vị kinh doanh - full luồng

  @hspheduyetDVKD_full_returnA6_editA8-01
  ...
  @hspheduyetDVKD_full_returnA6_editA8-03
  ...
  @hspheduyetDVKD_full_returnA6_editA8-04
  ...
  @hspheduyetDVKD_full_returnA6_editA8-05
  ...
  @hspheduyetDVKD_full_returnA6_editA8-06
  Scenario: approve with user a4nv
    Given I access link with "a4nv" and "Abc123!@#"
    When I search with the above request code from "QLPheDuyetYeuCau"
    And I send request with the above file code from A4 user
  ...
  @hspheduyetDVKD_full_returnA6_editA8-07
  ...
  @hspheduyetDVKD_full_returnA6_editA8-08
...
#      | Phê duyệt tại ĐVKD |
  ...
  @hspheduyetDVKD_full_returnA6_editA8-09
  Scenario: approve with user a8nv
    Given I access link with "a8nv" and "Abc123!@#"
    When I search with the above request code from "QLPheDuyetYeuCau"
    ...
    And I edit information in Thông tin thẻ tín dụng
      | Địa chỉ công ty | SALE_ONLINE | Bưu điện | Miễn 50% phí thường niên | Địa chỉ thường trú | Chi nhánh Lãnh Binh Thăng | 001-Local Credit Gold | RGL | Không trích nợ tự động | 24 |TN04 - TN từ chủ DN |
    Then I save all information
