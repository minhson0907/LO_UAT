...
Feature: Hồ sơ phê duyệt tại Đơn vị kinh doanh - full luồng
  ...
  Scenario Outline: register Hồ sơ thẻ phê duyệt tại Đơn vị kinh doanh with cif number
    ...
    And I fill all data in Thông tin thẻ tín dụng
      | CN/PGD HDBank | <client code> | Email | <fee policy> | Địa chỉ thường trú | CN LANH BINH THANG | <card type> | Không trích nợ tự động | QC TEST | 011252487 | 0983234167 | 12 |
...
#      | Thẩm định hồ sơ    |
  ...
  Scenario: approve with user a3nv
    ...
    And I edit information in Thông tin thẻ tín dụng
      | Địa chỉ công ty | SALE_ONLINE | Bưu điện | Miễn 50% phí thường niên | Địa chỉ thường trú | CN PHU NHUAN | 001-Visa Credit Vietjet SOVICO VIP | RGL | Không trích nợ tự động | 24 |
